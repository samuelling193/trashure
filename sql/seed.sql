...
-- RESERVATIONS
 ...
 update trashure_items set status = 'reserved' where item_id = 1;

 insert into reservations (owner_id, requester_id, item_id) values (1, 2, 2);
 update trashure_items set status = 'reserved' where item_id = 2;

 insert into reservations (owner_id, requester_id, item_id) values (3, 2, 4);
 update trashure_items set status = 'reserved' where item_id = 4;
